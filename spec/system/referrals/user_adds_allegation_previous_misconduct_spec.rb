...
RSpec.feature "Employer Referral: Previous Misconduct", type: :system do
  ...
  scenario "User provides details of previous misconduct" do
    ...
    when_i_click_on_previous_misconduct
    then_i_see_the_check_your_answers_page("Previous allegations", "allegation_previous_misconduct")
  ...
  def then_i_see_the_details_prefilled
    expect(page).to have_field("Description of previous allegations", with: "Some details")
  end

  def then_i_see_the_previous_misconduct_details_page
    expect(page).to have_current_path(
      edit_referral_allegation_previous_misconduct_detailed_account_path(@referral)
    )
  end

  def then_i_see_the_previous_misconduct_reported_page
    expect(page).to have_current_path(
      edit_referral_allegation_previous_misconduct_reported_path(@referral),
      ignore_query: true
    )
  ...
  def then_i_see_the_missing_details_error
    expect(page).to have_content("Select how you want to give details about previous allegations")
  end

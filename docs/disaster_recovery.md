...
Run the [Recover deleted postgres database server workflow](https://github.com/DFE-Digital/refer-serious-misconduct/actions/workflows/postgres-recover-deleted-db.yml) to recreate the missing postgres database.
...
Run the [deploy workflow](https://github.com/DFE-Digital/refer-serious-misconduct/actions/workflows/build-and-deploy.yml) to recreate the missing postgres database as detailed below.
...
Run the [Restore database from Azure storage workflow](https://github.com/DFE-Digital/refer-serious-misconduct/actions/workflows/database-restore.yml).
...
If users have entered data or new users have signed up, we may need to keep this data for reconciliation later on. Use the [Backup database to Azure storage workflow](https://github.com/DFE-Digital/refer-serious-misconduct/actions/workflows/backup-db.yml) to save a copy of the flawed database. Use a specific name to identify the backup file later on.
...
To perform a complete restore of the live server from the PTR copy, use the [Restore database from Azure storage workflow](https://github.com/DFE-Digital/refer-serious-misconduct/actions/workflows/database-restore.yml) and choose the backup file created above to restore to the live postgres server.

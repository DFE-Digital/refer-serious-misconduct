class ChangePreviousMisconductFields < ActiveRecord::Migration[7.0]
  change_table :referrals, bulk: true do |t|
    reversible do |dir|
      dir.up do
        t.remove :previous_misconduct_details_incomplete_at if t.column_exists?(:previous_misconduct_details_incomplete_at)
      ...
      dir.down do
        t.datetime :previous_misconduct_details_incomplete_at unless t.column_exists?(:previous_misconduct_details_incomplete_at)

module EligibilityScreener
  class TeachingInEnglandController < EligibilityScreenerController
    def new
      @teaching_in_england_form = EligibilityScreener::TeachingInEnglandForm.new(eligibility_check:)
    end

    def create
      @teaching_in_england_form =
        EligibilityScreener::TeachingInEnglandForm.new(
    ...
    def teaching_in_england_form_params
      params.require(:eligibility_screener_teaching_in_england_form).permit(:teaching_in_england)
    end
  end
end

...
Rails.application.routes.draw do
  ...
  constraints(-> { FeatureFlags::FeatureFlag.active?(:eligibility_screener) }) do
    ...
    get "/have-you-complained", to: "eligibility_screener/have_complained#new"
    post "/have-you-complained", to: "eligibility_screener/have_complained#create"
    get "/recently-complained", to: "eligibility_screener/recently_complained#new"
    post "/recently-complained", to: "eligibility_screener/recently_complained#create"
    get "/have-recently-complained", to: "pages#have_recently_complained"
    ...
    get "/unsupervised-teaching", to: "eligibility_screener/unsupervised_teaching#new"
    post "/unsupervised-teaching", to: "eligibility_screener/unsupervised_teaching#create"

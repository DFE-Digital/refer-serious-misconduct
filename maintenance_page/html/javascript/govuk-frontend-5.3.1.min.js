...
function normaliseString(e, t) {
  ...
  switch (
    (i ||
      (["true", "false"].includes(s) && (i = "boolean"),
      s.length > 0 && isFinite(Number(s)) && (i = "number")),
    i)
  ) {
    case "boolean":
      n = "true" === s;
...
function extractConfigByNamespace(e, t, s) {
  ...
  for (const [o, r] of Object.entries(t)) {
    ...
    for (const [n, i] of t.entries())
      "object" == typeof e &&
        (n < t.length - 1
          ? (isObject(e[i]) || (e[i] = {}), (e = e[i]))
          : o !== s && (e[i] = normaliseString(r)));
  }
  return i[s];
}
...
function setFocus(e, t = {}) {
  ...
  (n || e.setAttribute("tabindex", "-1"),
    ...
    null == (s = t.onBeforeFocus) || s.call(e),
    e.focus());
}
...
function normaliseDataset(e, t) {
  const s = {};
  for (const [n, i] of Object.entries(e.schema.properties))
    (n in t && (s[n] = normaliseString(t[n], i)),
      "object" === (null == i ? void 0 : i.type) && (s[n] = extractConfigByNamespace(e, t, n)));
  return s;
}
...
class SupportError extends GOVUKFrontendError {
  constructor(e = document.body) {
    ...
    (super(e ? t : 'GOV.UK Frontend initialised without `<script type="module">`'),
...
class ElementError extends GOVUKFrontendError {
  constructor(e) {
    ...
    if ("object" == typeof e) {
      const { componentName: s, identifier: n, element: i, expectedType: o } = e;
      ((t = `${s}: ${n}`),
        (t += i ? ` is not of type ${null != o ? o : "HTMLElement"}` : " not found"));
    }
...
class I18n {
  constructor(e = {}, t = {}) {
    ...
    ((this.translations = void 0),
      (this.locale = void 0),
      (this.translations = e),
      (this.locale = null != (s = t.locale) ? s : document.documentElement.lang || "en"));
  }
  t(e, t) {
  ...
  replacePlaceholders(e, t) {
    const s = Intl.NumberFormat.supportedLocalesOf(this.locale).length
  ...
  hasIntlPluralRulesSupport() {
    return Boolean(
      "PluralRules" in window.Intl && Intl.PluralRules.supportedLocalesOf(this.locale).length,
    );
  }
  getPluralSuffix(e, t) {
...
class Accordion extends GOVUKFrontendComponent {
  constructor(t, s = {}) {
    ...
    ((this.$module = t),
      (this.config = mergeConfigs(Accordion.defaults, s, normaliseDataset(Accordion, t.dataset))),
    ...
    ((this.$sections = n),
      (this.browserSupportsSessionStorage = e.checkForSessionStorage()),
      this.initControls(),
  ...
  initSectionHeaders() {
    this.$sections.forEach((e, t) => {
      ...
      (this.constructHeaderMarkup(s, t),
        this.setExpanded(this.isExpanded(e), e),
        s.addEventListener("click", () => this.onSectionToggle(e)),
    ...
    (a.push(h),
      ...
      e
        ? (o.removeAttribute("hidden"),
          ...
          s.classList.remove(this.downChevronIconClass))
        : (o.setAttribute("hidden", "until-found"),
          t.classList.remove(this.sectionExpandedClass),
          s.classList.add(this.downChevronIconClass)));
...
class Button extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    ((this.$module = e),
      (this.config = mergeConfigs(Button.defaults, t, normaliseDataset(Button, e.dataset))),
...
class CharacterCount extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    let r = {};
    (("maxwords" in o || "maxlength" in o) && (r = { maxlength: void 0, maxwords: void 0 }),
    ...
    const a = (function (e, t) {
      ...
      for (const [n, i] of Object.entries(e)) {
        const e = [];
        if (Array.isArray(i)) {
          for (const { required: s, errorMessage: n } of i) s.every((e) => !!t[e]) || e.push(n);
    ...
    ((this.i18n = new I18n(this.config.i18n, {
      ...
      (this.maxLength =
        null != (s = null != (n = this.config.maxwords) ? n : this.config.maxlength) ? s : 1 / 0),
      (this.$module = e),
      (this.$textarea = i));
  ...
  handleFocus() {
    this.valueChecker = window.setInterval(() => {
      (!this.lastInputTimestamp || Date.now() - 500 >= this.lastInputTimestamp) &&
  ...
  formatCountMessage(e, t) {
    ...
    return this.i18n.t(`${t}${s}`, { count: Math.abs(e) });
  }
  isOverThreshold() {
...
class Checkboxes extends GOVUKFrontendComponent {
  constructor(e) {
    if ((super(), (this.$module = void 0), (this.$inputs = void 0), !(e instanceof HTMLElement)))
      throw new ElementError({
  ...
  syncConditionalRevealWithInputState(e) {
    ...
    if (null != s && s.classList.contains("govuk-checkboxes__conditional")) {
      ...
      (e.setAttribute("aria-expanded", t.toString()),
        s.classList.toggle("govuk-checkboxes__conditional--hidden", !t));
    }
  }
  ...
  unCheckExclusiveInputs(e) {
    document
      .querySelectorAll(`input[data-behaviour="exclusive"][type="checkbox"][name="${e.name}"]`)
      .forEach((t) => {
...
class ErrorSummary extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    if ((super(), (this.$module = void 0), (this.config = void 0), !(e instanceof HTMLElement)))
      throw new ElementError({
  ...
  getAssociatedLegendOrLabel(e) {
    ...
    return null != (t = document.querySelector(`label[for='${e.getAttribute("id")}']`))
      ? t
      : e.closest("label");
  }
}
...
class ExitThisPage extends GOVUKFrontendComponent {
      ...
      ("Shift" !== e.key || this.lastKeyWasModified
        ...
        : ((this.keypressCounter += 1),
          ...
          this.timeoutMessageId &&
            (window.clearTimeout(this.timeoutMessageId), (this.timeoutMessageId = null)),
          this.keypressCounter >= 3
            ? ((this.keypressCounter = 0),
              this.keypressTimeoutId &&
                (window.clearTimeout(this.keypressTimeoutId), (this.keypressTimeoutId = null)),
              this.exitPage())
  ...
  resetPage() {
    (document.body.classList.remove("govuk-exit-this-page-hide-content"),
      ...
      this.$updateSpan &&
        (this.$updateSpan.setAttribute("role", "status"), (this.$updateSpan.textContent = "")),
      this.updateIndicator(),
      this.keypressTimeoutId && window.clearTimeout(this.keypressTimeoutId),
...
class PasswordInput extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    ((i.className = "govuk-password-input__sr-status govuk-visually-hidden"),
      i.setAttribute("aria-live", "polite"),
      (this.$screenReaderStatusMessage = i),
      this.$input.insertAdjacentElement("afterend", i),
  ...
  setType(e) {
    ...
    ((this.$showHideButton.innerText = this.i18n.t(`${s}Password`)),
      this.$showHideButton.setAttribute("aria-label", this.i18n.t(`${s}PasswordAriaLabel`)),
...
class Radios extends GOVUKFrontendComponent {
  ...
  syncConditionalRevealWithInputState(e) {
    ...
    if (null != s && s.classList.contains("govuk-radios__conditional")) {
      const t = e.checked;
      (e.setAttribute("aria-expanded", t.toString()),
        s.classList.toggle("govuk-radios__conditional--hidden", !t));
    }
  }
  handleClick(e) {
    const t = e.target;
...
class Tabs extends GOVUKFrontendComponent {
  ...
  setAttributes(e) {
    ...
    s &&
      ...
      s.setAttribute("aria-labelledby", e.id),
      s.classList.add(this.jsHiddenClass));
  }
  unsetAttributes(e) {
  ...
  onTabClick(e) {
    ...
    t &&
      ...
      (e.preventDefault(), this.hideTab(t), this.showTab(s), this.createHistoryEntry(s));
  }
